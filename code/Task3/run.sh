...
python main.py --model RandomForest --n_estimator 11 --max_depth 16 --criterion gini --n_threshold 128 --split_data_size 0.5 --device cpu
python main.py --model RandomForest --n_estimator 15 --max_depth 16 --criterion gini --n_threshold 128 --split_data_size 0.5 --device cpu
python main.py --model RandomForest --n_estimator 19 --max_depth 16 --criterion gini --n_threshold 128 --split_data_size 0.5 --device cpu

python main.py --model RandomForest --n_estimator 11 --max_depth 16 --criterion entropy --n_threshold 128 --split_data_size 0.5 --device cpu
python main.py --model RandomForest --n_estimator 15 --max_depth 16 --criterion entropy --n_threshold 128 --split_data_size 0.5 --device cpu
python main.py --model RandomForest --n_estimator 19 --max_depth 16 --criterion entropy --n_threshold 128 --split_data_size 0.5 --device cpu
